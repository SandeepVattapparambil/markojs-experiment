$_mod.def("/marko$4.10.0/src/runtime/vdom/vdom", function(require, exports, module, __filename, __dirname) { var VNode = require('/marko$4.10.0/src/runtime/vdom/VNode'/*"./VNode"*/);
var VComment = require('/marko$4.10.0/src/runtime/vdom/VComment'/*"./VComment"*/);
var VDocumentFragment = require('/marko$4.10.0/src/runtime/vdom/VDocumentFragment'/*"./VDocumentFragment"*/);
var VElement = require('/marko$4.10.0/src/runtime/vdom/VElement'/*"./VElement"*/);
var VText = require('/marko$4.10.0/src/runtime/vdom/VText'/*"./VText"*/);
var VComponent = require('/marko$4.10.0/src/runtime/vdom/VComponent'/*"./VComponent"*/);
