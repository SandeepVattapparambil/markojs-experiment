$_mod.def("/marko$4.10.0/src/components/event-delegation", function(require, exports, module, __filename, __dirname) { var componentsUtil = require('/marko$4.10.0/src/components/util-browser'/*"./util"*/);
...
function attachBubbleEventListeners(doc) {
    ...
    require('/marko$4.10.0/src/components/bubble'/*"./bubble"*/).forEach(function addBubbleHandler(eventType) {
