$_mod.def("/marko$4.10.0/src/morphdom/index", function(require, exports, module, __filename, __dirname) { "use strict";
var specialElHandlers = require('/marko$4.10.0/src/morphdom/specialElHandlers'/*"./specialElHandlers"*/);
var componentsUtil = require('/marko$4.10.0/src/components/util-browser'/*"../components/util"*/);
var existingComponentLookup = componentsUtil.___componentLookup;
var destroyNodeRecursive = componentsUtil.___destroyNodeRecursive;
var VElement = require('/marko$4.10.0/src/runtime/vdom/vdom'/*"../runtime/vdom/vdom"*/).___VElement;
var virtualizeElement = VElement.___virtualize;
var morphAttrs = VElement.___morphAttrs;
var eventDelegation = require('/marko$4.10.0/src/components/event-delegation'/*"../components/event-delegation"*/);
